...
export default function RT03Billing() {
  ...
  return (
    <PageLayout activeMenu="rt03">
      <div className="mb-6 flex justify-between items-center">
        <div>
          <h2 className="text-2xl font-bold text-blue-900">RT 03 Financial Overview</h2>
          <p className="text-slate-500 text-sm mt-1">Manage monthly dues and payment records for residents of RT 03.</p>
        </div>
      ...
      <div className="bg-white border border-slate-200 rounded-xl shadow-sm mb-6 flex flex-col">
        ...
        <div className="p-5 border-b border-slate-200 flex justify-between items-center bg-slate-50 rounded-t-xl">
          <h3 className="font-bold text-lg text-slate-800">Tabel Iuran Warga RT 03</h3>
